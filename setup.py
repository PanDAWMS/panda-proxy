...
setup(
    ...
    description=' PanDA Proxy Package',
    long_description='''This package contains PanDA Proxy Components''',
    license='GPL',
    author='Panda Team',
    ...
    data_files=[
                ...
                # sysconfig
                ('etc/sysconfig', ['templates/panda_proxy-sysconfig.rpmnew.template',
                                   ]
                 ),
                # init script
